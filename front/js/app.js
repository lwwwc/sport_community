window.app = {
	 ...
	 */
	//todo 修改
	nettyServerUrl: 'ws://3ec11ddc.r16.cpolar.top/ws',
	
	/**
	 * 后端服务发布的url地址
	 */
	//todo 修改
	serverUrl: 'http://im7tif.natappfree.cc',
	
	/**
	 * 图片服务器的url地址
	 */
	imgServerUrl: 'http://119.16.67.114:8070/group1/',
	...
	sportCodeUrl: "https://oauth-login.cloud.huawei.com/oauth2/v3/authorize?" + 
					...
					"http://im7tif.natappfree.cc/detection/getCode&scope=openid+https%3A%2F%2Fwww.huawei.com%2Fhealthkit%2Fstep.read+"+
